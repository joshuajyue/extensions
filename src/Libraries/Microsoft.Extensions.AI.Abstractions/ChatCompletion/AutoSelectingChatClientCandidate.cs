...
/// <summary>
/// A candidate <see cref="IChatClient"/> that an <see cref="AutoSelectingChatClient"/> may route requests to.
/// </summary>
public class AutoSelectingChatClientCandidate
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AutoSelectingChatClientCandidate"/> class.
    /// </summary>
    ...
    public AutoSelectingChatClientCandidate(string name, IChatClient client, string? providerName = null, string? modelId = null)
    {
